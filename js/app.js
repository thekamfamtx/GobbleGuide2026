...
const openKam = document.getElementById("openKamCorner");
const closeKam = document.getElementById("closeKamCorner");
const overlay = document.getElementById("kamOverlay");

if(openKam){

    openKam.addEventListener("click",()=>{
...
if(closeKam){
    ...
    closeKam.addEventListener("click",()=>{
